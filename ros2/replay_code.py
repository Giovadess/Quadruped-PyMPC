...
class Quadruped_PyMPC_Node(Node):
    def __init__(self):
        ...
        self.publisher_control_signal_debug = self.create_publisher(ControlSignal,"/quadruped_pympc_torques_db", 1)
        self.publisher_trajectory_generator_debug = self.create_publisher(TrajectoryGenerator,"/trajectory_generator_db", 1)
    ...
    def compute_control_callback(self):
        ...
        self.publisher_control_signal_debug.publish(control_signal_msg) 
        ...
        self.publisher_trajectory_generator_debug.publish(trajectory_generator_msg)
        ...
        self.publisher_time_debug_debug.publish(time_debug_msg)
        ...
        self.publisher_arm_interface_debug.publish(passive_arm_msg)
